...
public class Temporada {
	 ...
	 * 
	 * @throws SerieException:    si no encuentra el capítulo que indica la
...
public String escribeFichero() {
	return this.nombreTemporada+","+this.numeroCapitulos()+","+this.sumaOpiniones+","+this.numeroOpiniones;
}
